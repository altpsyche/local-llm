...
COMMANDS = [
    ...
    {"name": "update", "group": "Provisioner", "summary": "Update submodules and rebuild",
     "args": "", "runtime": "pwsh", "handler": None},
    {"name": "lock", "group": "Provisioner", "summary": "(Re)generate versions.lock from the pinned sources (ND1)",
     "args": "[--check]", "runtime": "pwsh", "handler": None},
    {"name": "version", "group": "Provisioner", "summary": "Show the Bob release + component versions",
     "args": "", "runtime": "pwsh", "handler": None},
